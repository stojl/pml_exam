...
class BayesianVAE(nn.Module):
    ...
    def guide(self, x):
        ...
        b1_map = pyro.param("b1_map", torch.tensor(0.5))
        ...
        w2_map = pyro.param("w2_map", torch.tensor(0))
        ...
        w3_map = pyro.param("w3_map", torch.tensor(0))
        b3_map = pyro.param("b3_map", torch.tensor(0.5))
